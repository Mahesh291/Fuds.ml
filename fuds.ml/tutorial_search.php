...
if(strlen($query) >= $min_length){
	...
	$row_results = mysqli_query($con,"SELECT * FROM tutorial WHERE (`file` LIke '%".$query."%') OR (`descr` LIke '%".$query."%') ") or die(mysqli_error());
...
<a onclick="load()" style="text-decoration:none;" href="tutorial1.php?que=<?php echo $row['id'];?>&file=">	
<div style="width:300px; height:200px; overflow:hidden;  background:rgb(10,10,10); ">
<embed src="http://localhost/j/<?php echo $row['file'];?>" style="height:200px;">
</div>
