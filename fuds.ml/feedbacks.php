...
<div id="top" style="">
<h1 id="top1" style="color:rgb(250,10,100);">Feedbacks</h1>
</div>
<a href="tools2.php">
<div id="top" style="">
...
<br/>
<?php
$result1 = mysqli_query($con,"SELECT * FROM feedback") or die(mysqli_error());
	while($row = mysqli_fetch_array($result1)){
   ?>
   <h4 style="color:rgb(50,50,50); font-size:14px; font-weight:bold;  max-width:340px; background:rgb(250,100,30); padding:10px; border-radius:2px; ">
