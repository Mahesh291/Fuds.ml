...
<body style="padding:0px;margin:0px; ;background:rgb(50,50,50); background-size:100%;;">
...
<span style="margin-top:10px;"class="glyphicon glyphicon-earphone"></span> <p style="margin-left:25px;font-weight:bold; letter-spacing:1px;font-family: 'Oswald', sans-serif;font-size:14.5px;margin-top:-16px;" >+91 903 914 3865
 ...
 padding-top:20px;
 margin-top:-20px;
 height:60px;" >ABOUT US<span class="caret"></span></li></a>
...
<div id="about" style="width:80%; min-width:340px;  padding:10px; min-height:400px; background:url(about5.jpg); background-size:100% 100%;;opacity:0.8;">
<h3 style="color:rgb(250,10,10); font-weight:bold; opacity:1;font-family: 'Roboto', sans-serif;">
About Us</h3>

<div style="display:block; width:230px;margin-left:10px; margin-top:-10px; height:50px; float:left;">
<h4 style="color:rgb(200,200,200);float:left; font-weight:bold; font-size:14px;">Founder : Mahesh Sharma</h4>
<h4 style="color:rgb(200,200,200);font-weight:bold; float:left;font-size:14px;">CEO : Rakesh Mishra</h4>

</div>

<div style="display:block;;margin-top:80px; background:rgb(0,0,0); padding:16px;opacity:0.8;width:80%;border-radius:3px; min-width:320px; ">

<p id="content" style="color:rgb(230,230,230); font-family: 'Roboto', sans-serif;">
This website is created by <b style="color:rgb(250,10,10);">Madhusudan Patidar..</b> He is a great technology lover and always wish to do something in the field of technology..
His main interest is in the field of software security .Therefore he created this website to spread his knowledge to other students so they can know about the world of software and security for software</p>
</div>
<div style="display:block; width:230px;margin-left:10px; margin-top:10px; height:50px; float:right;">
<p style="color:rgb(250,250,250);  font-size:13px;"><b>Madhusudan Patidar:</b><span style="color:rgb(230,230,230); ">Founder of Fuds.ml and senior security expert at Fuds.ml</p>
</div>
