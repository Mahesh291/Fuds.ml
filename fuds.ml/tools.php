...
function show(str) {
  ...
  xhttp.open("GET", "tools_search.php?q="+str, true);
  xhttp.send();   
...
<button href="javascript:void(0);" id="back" onclick="show2()" style="background:white; width:30px;border:none;margin-left:50%;position:absolute;margin-top:-38px;height:20px; "><i class="material-icons">&#xE14A;</i></button>
...
<span style="margin-top:10px;"class="glyphicon glyphicon-earphone"></span> <p style="margin-left:25px;font-weight:bold; letter-spacing:1px;font-family: 'Oswald', sans-serif;font-size:14.5px;margin-top:-16px;" >+91 903 914 3865
 ...
 padding-top:20px;
 margin-top:-20px;
 height:60px; ">TOOLS<span class="caret"></span></li></a>
...
<?php
	...
	$result = mysqli_query($con,"SELECT * FROM tools") or die(mysqli_error());
